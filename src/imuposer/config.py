...
class Config:
    def __init__(
        ...
        use_glb_rot_loss=False,
        use_acc_recon_loss=False,
        pred_joints_set=None,
        pred_last_frame=False,
        use_vposer_loss=False,
        use_vel_loss=False,
    ):
        ...
        self.pred_joints_set = (
            [*range(24)] if pred_joints_set == None else pred_joints_set
        )
    ...
    def build_paths(self):
        ...
        self.og_smpl_model_path = (
            self.root_dir / "src/imuposer/smpl/basicmodel_m_lbs_10_207_0_v1.0.0.pkl"
        )
        ...
        if self.mkdir:
            if self.experiment != None:
                ...
                self.checkpoint_path = (
                    self.root_dir / f"checkpoints/{self.experiment}-{datestring}"
                )
